...
public class SpecificPolicyExceptionTest {
    ...
    public void shouldConstructFromMessageType() {
        ...
        final SpecificPolicyException exception = new SpecificPolicyException(TestErrorType.TYPE_1) { };
    ...
    public void shouldConstructFromMessageTypeAndArguments() {
        ...
        final SpecificPolicyException exception = new SpecificPolicyException(TestErrorType.TYPE_1, "A1", "A2") { };
        assertThat(exception.getErrorMessageType(), is(TestErrorType.TYPE_1));
