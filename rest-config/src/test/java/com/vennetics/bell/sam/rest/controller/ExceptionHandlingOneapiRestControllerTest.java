 ...
 */
@RunWith(MockitoJUnitRunner.class) public class ExceptionHandlingOneapiRestControllerTest {

    // Object under test
    @Autowired @InjectMocks private DummyOneapiRestController controller;

    // Mock Objects
    @Mock private ObjectMapper jsonObjectMapper;

    @Mock private IExceptionTypeMapper exceptionTypeMapper;
    @Mock private OneapiErrorAdapter errorAdapter;
...
class DummyOneapiRestController extends ExceptionHandlingOneapiRestController {
}
